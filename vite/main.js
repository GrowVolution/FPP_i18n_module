...
`
    ...
    await fpp.socketHtmlInject("i18n_entries", tbody);
    ...
    async function entryData(key, domain) {
        return await fpp.emitAsync("i18n_entry_data", {
            key: key,
            domain: domain
        });
    }
    ...
    tbody.querySelectorAll("tr").forEach(tr => {
        ...
        deleteButton.addEventListener("click", async () => {
            ...
            const r = await fpp.emitAsync("i18n_delete_entry", {
                key: key,
                domain: domain
            });
            ...
            fpp.socketHtmlInject("i18n_entries", tbody);
        });
    });
    ...
    modalSaveButton.addEventListener("click", async () => {
        ...
        const r = await fpp.emitAsync("i18n_save_entry", {
